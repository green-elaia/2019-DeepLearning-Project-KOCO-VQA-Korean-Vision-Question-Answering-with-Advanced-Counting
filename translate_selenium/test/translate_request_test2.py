...
# python3 translate_request_test2.py --enfile /mnt/crawl/VQA_v2/v2_Questions_Train_mscoco/v2_OpenEnded_mscoco_train2014_questions.json --kofile /mnt/crawl/VQA_v2/v2_Questions_Train_mscoco/ko2_v2_OpenEnded_mscoco_train2014_questions.json
