...
# python3 anno_train45.py --enfile /mnt/crawl/VQA_v2/v2_Annotations_Train_mscoco/v2_mscoco_train2014_annotations.json --kofile /mnt/crawl/VQA_v2/v2_Annotations_Train_mscoco/ko45_v2_mscoco_train2014_annotations.json
