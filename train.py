...
def main():
    ...
    target_name = os.path.join('/mnt/crawl/ryan/count_demo/vqa-v2/logs/')
    if not args.test:
    ...
    for i in range(config.epochs):
        ...
        if not args.test:
            ...
            if i % 5 == 0:
                ...
                save_name = target_name + '{0}_{1}.pth'.format(now, i)
                results = {
                    'name': name,
            ...
            with open('test_result/results_test.json', 'w') as fd:
