...
from networks.fusions.fusions import MCB, MCB_classify, MLB
...
class Classifier(nn.Sequential):
    ...
    def forward(self, x, y, c):
        x = self.fusion(self.lin11(self.drop(x)), self.lin12(self.drop(y)), "classi")
